      ...
      <div>
        ...
        <div className="mt-3 flex justify-between items-start ">
          ...
          <div>
            ...
            <div className="gap-2 mt-1.5 shadow-lg rounded-full bg-blue-gray-100 flex flex-row justify-between items-center">
              <button
                onClick={decreament}
                className="hover:bg-blue-400 duration-300 relative bg-white align-middle select-none font-sans font-medium text-center uppercase transition-all disabled:opacity-50 disabled:shadow-none disabled:pointer-events-none w-[25px]  h-[25px] text-xs shadow-md shadow-gray-900/10 hover:shadow-lg hover:shadow-gray-900/20 active:opacity-[0.85] rounded-full"
              >
