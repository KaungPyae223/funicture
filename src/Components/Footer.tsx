      ...
      <footer className="relative w-full">
        <div className="mx-auto w-full max-w-7xl px-8">
          <div className="grid grid-cols-1 justify-between gap-10 lg:gap-4 md:grid-cols-2">
            <div>
              ...
              <p className="text-sm max-w-[350px] mb-3">
                ...
                deleniti neque! Architecto, cupiditate possimus! Quam eos enim
                adipisci recusandae tempora?
              </p>
              <div className="flex flex-row gap-3 items-center mb-1">
                <IoLocation className="text-lg" />
                <p className="text-sm">Australia Sydney</p>
              </div>
              <div className="flex flex-row gap-3 items-center">
                <MdOutlineEmail className="text-lg" />
                <p className="text-sm">www.Info@Alexa.com</p>
              </div>
          ...
          <div className="mt-12 flex w-full flex-col items-center justify-center border-t border-blue-gray-50 py-4 md:flex-row md:justify-between">
            ...
            >
              &copy; {currentYear}{" "}
              <a href="https://material-tailwind.com/">Alexa</a>. All Rights
              Reserved.
            </Typography>
